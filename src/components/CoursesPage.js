                ...
                <div className="p-pl-3 p-pr-6">
                  ...
                  <Card id="c3" title="Иврит для IT"  subTitle="Подготовка к собеседованиям" >
                    ...
                    <Card id="c8" title="Технический английский"  subTitle="Для IT - индустрии" >
                        ...
                        <li>Урок 1. Грамматика. Мировоззрение и построение предложений. Глаголы. Простое настоящее.</li>
                        <li>Урок 2. Грамматика. Неправильные глаголы. Прошлое простое.</li>
                        <li>Урок 3. Грамматика. Настоящее прогрессивное.</li>
                        <li>Урок 4. Грамматика. Прошлое прогрессивное. Моя легенда.</li>
                        <li>Урок 5. Грамматика. Будущие времена. Специальная лексика.</li>
                        ...
                        <li>Урок 9. Грамматика. Пассив. Чтение научных текстов по информатике.</li>
                        <li>Урок 10. Придаточное предложение. “Если” предложения. Прямая / докладная речь. Настоящее совершенное</li></ui>
                        </div>
                      </Card>         
                {/* </div>
