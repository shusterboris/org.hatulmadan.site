         ...
         <div className="p-grid ">
            ...
            <div className="p-col-9">
                <Card id="n1" title="Открытый урок для курса QA" style={{ width: '65em' }}>
                         Состоялось очное занятие в Хайфе для одной из групп будущих тестировщиков. На него были приглашены все желаюющие. 
                ...
                <Card id="n2" title="Как устроен Scratch" style={{ width: '65em' }}>
                       <p>
                          ...
                          Код (Code) — что шарик может делать;
                            Костюм (Sprite) — как шарик выглядит;
                            Звуки (Sounds) — какие звуки он умеет издавать
                            Код набирается из готовых элементов, например "пройти Х шагов", повернуть на Х градусов, повторить Х раз. 
