            ...
            <div className="p-d-flex p-flex-column p-flex-md-row">
               ...
               <div className="p-mr-5 p-pt-6 p-md-6">
                  ...
                  <div className="p-pt-6">
                     ...
                     <h5 className="p-text-justify">  <b>Взрослым</b>: ручное и автоматизированное тестирование, тренинги по подготовке к собеседованиям,
                     ...
                     В ходе обучения предлагаем всем желающим работать с реальными проектами, получать практический опыт и решать реальные задачи.</h5>
